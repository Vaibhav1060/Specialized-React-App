          ...
          <div className="BikesMenu-Group">
            ...
            <div className="BikesMenu-ItemWrap">
              ...
              <div className={TrailClasses}>
                <Link to="/stumpjumperpro" className="BikesMenu-SecondaryText">
                  StumpJumper Pro 29
                </Link>

                <Link
                  to="/stumpjumperexpert29"
                  className="BikesMenu-SecondaryText"
                >
                  StumpJumper Expert 29
                </Link>
                <Link
                  to="/stumpjumperexpert27"
                  className="BikesMenu-SecondaryText"
                >
            ...
            <div className="BikesMenu-ItemWrap">
              ...
              <div className={DownHillClasses}>
                <Link to="/demoracer29" className="BikesMenu-SecondaryText">
                  Demo Racer 29
                </Link>
                <Link to="/demoexpert29" className="BikesMenu-SecondaryText">
                  Demo Expert 29
                </Link>
                <Link to="/demoalloy27" className="BikesMenu-SecondaryText">
                  Demo Alloy 27.5
                </Link>
              </div>
            </div>
            ...
            <div className="BikesMenu-ItemWrap">
              ...
              <div className={SWorksClasses}>
                <Link to="/demo8" className="BikesMenu-SecondaryText">
                  S-Works Demo 8
                </Link>
                <Link to="/epicevo" className="BikesMenu-SecondaryText">
                  S-Works Epic EVO
                </Link>
                <Link to="/stumpjumper29" className="BikesMenu-SecondaryText">
