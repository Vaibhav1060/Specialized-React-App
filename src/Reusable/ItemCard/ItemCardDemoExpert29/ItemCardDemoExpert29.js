...
import './ItemCardDemoExpert29.scss';
import { Link } from 'react-router-dom';

export default function ItemCardDemoExpert29() {
    return (
        <div className='ItemCard-DemoExpert29'>
            <div className='ItemCardWrap'>
                <div className='ItemCard-Column'>
                    <p className='ItemCard-Name'>Demo Expert 29</p>
                    <div className='ItemCard-PricePart'>
                        <p className='ItemCard-Price'>$5,000.00</p>
                        <p className='ItemCard-PartNumber'>Part No. 94519-0007</p>
                    </div>
                </div>
                <div className='ItemCard-Column ItemCard-Column2'>
                    <p className='ItemCard-Color'>Light Blue / Orange / Black / Metallic Black</p>
