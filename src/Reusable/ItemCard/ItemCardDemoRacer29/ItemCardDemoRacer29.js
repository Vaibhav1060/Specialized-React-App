...
import './ItemCardDemoRacer29.scss';
import { Link } from 'react-router-dom';

export default function ItemCardDemoRacer29() {
    return (
        <div className='ItemCard-DemoRacer29'>
            <div className='ItemCardWrap'>
                <div className='ItemCard-Column'>
                    <p className='ItemCard-Name'>Demo Racer 29</p>
                    <div className='ItemCard-PricePart'>
                        <p className='ItemCard-Price'>$6,500.00</p>
                        <p className='ItemCard-PartNumber'>Part No. 94519-0006</p>
                    </div>
                </div>
                <div className='ItemCard-Column ItemCard-Column2'>
                    <p className='ItemCard-Color'>Dark Yellow / Black / Metallic Black</p>
